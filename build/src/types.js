...
exports.EntriesType = exports.dummySickLeave = exports.dummyDischarge = exports.HealthCheckRating = exports.Gender = void 0;
var Gender;
(function (Gender) {
    Gender["Male"] = "male";
...
exports.dummyDischarge = {
    date: ''
};
exports.dummySickLeave = {
    startDate: '',
    endDate: ''
};
var EntriesType;
...
})(EntriesType || (exports.EntriesType = EntriesType = {}));
